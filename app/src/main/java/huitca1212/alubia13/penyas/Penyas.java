...
public class Penyas extends Activity {
    ...
    private TitularPenyas[] datos =
            new TitularPenyas[]{
                    ...
                    new TitularPenyas("Costa azul"), new TitularPenyas("Desfase"), new TitularPenyas("Descoloke"), new TitularPenyas("DGT (Dirección General de Tragos)"),
                    new TitularPenyas("Dislokey"), new TitularPenyas("El Cachi"), new TitularPenyas("El Ginkgo"), new TitularPenyas("Embarazo no deseado"),
                    new TitularPenyas("Estress"),new TitularPenyas("EUKZ (El Último Ke Zierre)"), new TitularPenyas("FBI (Federación de Borrachos Inocentes)"),
                    ...
                    new TitularPenyas("La coral"), new TitularPenyas("Loonatics"), new TitularPenyas("Los colgaos"), new TitularPenyas("Motokaskaos"),
        ...
        lstOpciones.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                ...
                switch (position) {
                    ...
                    case 8:
                        d.setTitle("DGT");
                        im.setImageResource(R.drawable.dgt_g);
                        d.setContentView(im);
                        d.show();
                        break;
                    case 9:
                    ...
                    case 28:
                        ...
                        break;
                    case 29:
                        d.setTitle("Loonatics");
                        im.setImageResource(R.drawable.loonatics_g);
                        d.setContentView(im);
                        d.show();
                        break;
                    case 30:
    ...
    public Dialog crearDialogoContact(Context eso) {
        ...
        builder.setTitle(R.string.fotoPenya);
        builder.setMessage(R.string.fotoPenyaTexto);
        builder.setNegativeButton(R.string.whatsApp, new OnClickListener() {
        ...
        builder.setNeutralButton(R.string.email, new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
        ...
        builder.setPositiveButton(R.string.cancelar, new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
            }
        });
